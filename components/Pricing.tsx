      ...
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mt-12">
          ...
          <div className="bg-white p-6 rounded-xl shadow-lg inline-block">
            ...
            <p className="pt-8">
              Note: You can pay using{" "}
              <a href="https://www.sendwave.com/" className="text-blue-600">
                Sendwave
              </a>{" "}
              ,{" "}
              <a href="https://www.remitly.com/" className="text-blue-600">
                Remitly
              </a>{" "}
              ,{" "}
              <a href="https://www.wise.com/" className="text-blue-600">
                Wise
              </a>{" "}
              etc
            </p>
